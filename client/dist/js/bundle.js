...
var _registerRoutes = _interopRequireDefault(__webpack_require__(/*! boot/registerRoutes */ "./client/src/boot/registerRoutes.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
window.document.addEventListener('DOMContentLoaded', function () {
  (0, _registerRoutes["default"])();
...
var _LeftAndMain = __webpack_require__(/*! components/LeftAndMain */ "./client/src/components/LeftAndMain/index.js");
var _ReactAdminDefaultComponent = _interopRequireDefault(__webpack_require__(/*! ../components/ReactAdminDefaultComponent */ "./client/src/components/ReactAdminDefaultComponent.js"));
var _ReactAdminErrorComponent = _interopRequireDefault(__webpack_require__(/*! ../components/ReactAdminErrorComponent */ "./client/src/components/ReactAdminErrorComponent.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
var _default = function _default() {
  _Injector["default"].component.registerMany({
    LeftAndMain: _LeftAndMain.LeftAndMain,
    ReactAdminDefaultComponent: _ReactAdminDefaultComponent["default"],
    ReactAdminErrorComponent: _ReactAdminErrorComponent["default"]
  });
};
...
var _ReactAdminBoostrap = _interopRequireDefault(__webpack_require__(/*! components/ReactAdminBoostrap */ "./client/src/components/ReactAdminBoostrap.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
var _default = function _default() {
  if (typeof reactAdminConfig === 'undefined') {
    return;
  }
  var sectionConfig = _Config["default"].getSection(reactAdminConfig.configKey);
  _ReactRouteRegister["default"].add({
    path: "/".concat(sectionConfig.reactRoutePath),
    component: _ReactAdminBoostrap["default"],
    exact: false
  });
};
exports["default"] = _default;
...
var _excluded = ["current", "component", "className", "title", "children"],
  _excluded2 = ["key"];
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
...
var Action = function Action(_ref) {
  ...
  var actionClassName = (0, _classnames["default"])(className, 'action-bar__action');
  return _react["default"].createElement(ActionComponent, _extends({}, props, {
...
var ActionBar = function ActionBar(_ref2) {
  ...
  var actionBarClass = (0, _classnames["default"])('action-bar', 'fill-width', className, {
...
var _NavTabs = _interopRequireDefault(__webpack_require__(/*! ./NavTabs */ "./client/src/components/LeftAndMain/NavTabs.js"));
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "prop-types"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
...
var HeaderComponent = function HeaderComponent(_ref) {
  ...
  var crumbs = breadcrumbs && breadcrumbs.length > 0 ? breadcrumbs : [{
    text: title
  }];
  ...
  }, _react["default"].createElement(_Breadcrumb.Component, {
    multiline: true,
    crumbs: crumbs
  }), tabProps && _react["default"].createElement(_NavTabs["default"], tabProps));
};
HeaderComponent.propTypes = {
  title: _propTypes["default"].string,
  breadcrumbs: _Breadcrumb.Component.propTypes.crumbs,
  tabProps: _propTypes["default"].shape(_NavTabs["default"].propTypes)
};
...
var _react = _interopRequireDefault(__webpack_require__(/*! react */ "react"));
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "prop-types"));
var _HeaderComponent = _interopRequireDefault(__webpack_require__(/*! ./HeaderComponent */ "./client/src/components/LeftAndMain/HeaderComponent.js"));
var _ActionBar = _interopRequireDefault(__webpack_require__(/*! ./ActionBar */ "./client/src/components/LeftAndMain/ActionBar.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
...
var LeftAndMain = function LeftAndMain(_ref) {
  ...
  return _react["default"].createElement("div", {
  ...
  }, _react["default"].createElement(_HeaderComponent["default"], {
    ...
    actions: topActions
  }), children, _react["default"].createElement(_ActionBar["default"], {
    actions: bottomActions,
    position: "bottom"
  })));
};
LeftAndMain.propTypes = _objectSpread(_objectSpread({}, _HeaderComponent["default"].propTypes), {}, {
  topActions: _propTypes["default"].array,
  bottomActions: _propTypes["default"].array
});
...
var NavTab = function NavTab(_ref) {
  ...
  var tabClass = (0, _classnames["default"])('nav-tabs__tab-item', {
    'nav-tabs__tab-item--current': current
  });
  var linkClass = (0, _classnames["default"])(className, 'nav-tabs__link', {
    'nav-tabs__link--current': current
  });
  return _react["default"].createElement("li", {
    className: tabClass
  }, _react["default"].createElement(TabComponent, _extends({}, tabProps, {
    role: "tab",
    className: linkClass
  }), children || title));
};
var NavTabs = function NavTabs(_ref2) {
  ...
  var navTabClass = (0, _classnames["default"])(className, 'nav-tabs');
  return _react["default"].createElement("ul", {
    className: navTabClass,
    role: "tablist"
  }, tabs.map(function (_ref3) {
    var key = _ref3.key,
      tabProps = _objectWithoutProperties(_ref3, _excluded2);
    return _react["default"].createElement(NavTab, _extends({
      key: key,
      current: current === key,
      component: component
    }, tabProps));
...
Object.defineProperty(exports, "LeftAndMain", ({
  enumerable: true,
  get: function get() {
    return _LeftAndMain["default"];
  }
}));
var _LeftAndMain = _interopRequireDefault(__webpack_require__(/*! ./LeftAndMain */ "./client/src/components/LeftAndMain/LeftAndMain.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
...
var takeComponent = function takeComponent(componentName) {
  if (typeof componentName === 'string' && componentName !== '') {
    try {
      _Injector["default"].component.get(componentName);
...
var ReactAdminBoostrap = function ReactAdminBoostrap() {
  ...
  return _react["default"].createElement(RootComponent, props);
};
var _default = ReactAdminBoostrap;
exports["default"] = _default;
...
var ReactAdminDefaultComponent = function ReactAdminDefaultComponent() {
  return _react["default"].createElement(LeftAndMain, {
    breadcrumbs: breadcrumbs
  }, "To create new component, you should to do the following...");
};
var _default = ReactAdminDefaultComponent;
exports["default"] = _default;
...
var ReactAdminErrorComponent = function ReactAdminErrorComponent(_ref) {
  ...
  }, _react["default"].createElement("h1", null, "404"), _react["default"].createElement("h2", null, "Component Not Found :(")));
};
var _default = ReactAdminErrorComponent;
exports["default"] = _default;
...
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || _typeof(obj) !== "object" && typeof obj !== "function") { return { "default": obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj["default"] = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
_Injector["default"].ready(function () {
  _jquery["default"].entwine('ss', function ($) {
    $('.js-injector-boot .bootstrap-component').entwine({
      ...
      refresh: function refresh() {
        ...
        _reactDom["default"].render(_react["default"].createElement(Component, props), this[0]);
      },
  ...
  _jquery["default"].entwine('ss', function ($) {
    $('.js-injector-boot .react-form-field').entwine({
      ...
      onmatch: function onmatch() {
        ...
        if (hiddenInputId) {
          var input = $("#".concat(hiddenInputId));
      ...
      refresh: function refresh() {
        var props = this.getProps();
        var Component = this.getComponent();
        _reactDom["default"].render(_react["default"].createElement(Component, _extends({}, props, {
          noHolder: true
        })), this[0]);
      },
...
__webpack_require__(/*! ./BootstrapReactComponent */ "./client/src/legacy/entwine/BootstrapReactComponent.js");
__webpack_require__(/*! ./BootstrapReactFormField */ "./client/src/legacy/entwine/BootstrapReactFormField.js");
...
__webpack_require__(/*! ../legacy/entwine */ "./client/src/legacy/entwine/index.js");
